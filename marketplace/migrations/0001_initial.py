    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_views', models.IntegerField()),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('free_views_remaining', models.IntegerField(default=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.wallet')),
            ],
        ),
    ]
